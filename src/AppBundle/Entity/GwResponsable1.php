 ...
 * GwResponsable1
 *
 * @ORM\Table(name="gw_responsable1", indexes={@ORM\Index(name="IDX_C98B5CA9DF1E57AB", columns={"quartier_id"}), @ORM\Index(name="IDX_C98B5CA99F7E4405", columns={"secteur_id"}), @ORM\Index(name="IDX_C98B5CA9FDEF8996", columns={"profession_id"}), @ORM\Index(name="IDX_C98B5CA9CC054403", columns={"lieutravail_id"})})
 * @ORM\Entity
 */
class GwResponsable1
{
    /**
     * @var string
     *
